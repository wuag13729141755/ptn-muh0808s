...
void parseHDMI2VSDB(u8 VSDB[])
{
    ...
    if (iTE6615_DATA.sink.HDMIVer < 2) {
        #if _ENABLE_OUTPUT_SUPPORT_HDMI20
...
//char *strExtTag05_ColorimetryDataBlock[] ={
//    "ITE6615_xvYCC601 Standard Definition Colorimetry based on IEC 61966-2-4",
//    "ITE6615_xvYCC709 High Definition Colorimetry based on IEC 61966-2-4",
//    "ITE6615_sYCC601 Colorimetry based on IEC 61966-2-1/Amendment 1",
...
void iTE6615_Parser_EDID_block0( u8 *EDID )
{
    ...
    if( sum != 0 )
	{
        PRINTF_EDID(("\r\nEDID Block 0 Correct Checksum should be %02X\r\n",(EDID[127]-sum)&0xFF));
    }
	else
	{
		PRINTF_EDID(("\r\nEDID Block 0 Corrected EDID Checksum !\r\n");
	}
...
void iTE6615_Parser_EDID_block0( u8 *EDID )
{
    ...
    sum =  checksumEDID(EDID);
    if( sum != 0 ) {
        PRINTF_EDID(("EDID Block 0 Correct Checksum should be %02X\r\n",(EDID[127]-sum)&0xFF));
    }else{
		PRINTF_EDID(("EDID Block 0 Corrected Checksum \r\n"));
	}
}
...
void iTE6615_Parser_EDID_block1( u8 *EDID )
{
    ...
    if( sum != 0 ) {
        PRINTF_EDID(("EDID Block 1 Correct Checksum should be %02X\r\n",(EDID[127]-sum)&0xFF));
    }else{
		PRINTF_EDID(("EDID Block 1 Corrected Checksum \r\n"));
	}
                ...
                case 0x07:
                    switch (tmp[1]) {
                        ...
                        case 0x0F: // 420 CMDB
                            ...
                            break;
                        case 0x05:
                            iTE6615_DATA.sink.ExtColCap = tmp[2];   // for get Colorimetry infomation
                            break;
                    }
                    break;
