...
#define	IT6602_CEC_PRINT(x) IT6602_MSG( x)
#else
...
//xxxxx
 ...
 _CODE_CODE CECcmdFormat LookUpTable_CEC[]=
 {
...
BYTE ReadyFire, BusFree;
	...
	BusFree = (reg0x44&B_BUS_STATUS)>>1;
    	...
    	if( ReadyFire==1 && BusFree==1 )  // Ready Fire && Bus Free
    		...
    		{
    			//IT6602_MSG(("IT6602_CEC[44]SYS_STATUS=%X\n",reg0x44));
...
// // disable
// // disable 	MFCFGP0_0=0x02;				//HW INT1 P0.0 for connect with IT6602_CEC INT pin
// // disable 	IOCFGP0_0=0xa0;
// // disable
// // disable 	MFCFGP0_1=0x02;				//HW INT1 P0.0 for connect with IT6602_CEC INT pin
...
void IT6602_CECPowerOffByITEHDMI(unsigned char eCECActivePortNum)
{
	if(eCECActivePortNum == 0)
	{
		IT6602_CEC_PRINT(("IT6602_CECPower Off By ITEHDMI() active port --> HDMI PORT 0\r\n"));
	}
	else
	{
		IT6602_CEC_PRINT(("IT6602_CECPower Off By ITEHDMI() active port --> HDMI PORT 1\r\n"));
	}
...
void IT6602_CECPowerOnByITEHDMI(unsigned char eCECActivePortNum)
{
	if(eCECActivePortNum == 0)
	{
		IT6602_CEC_PRINT(("IT6602_CECPowerOn By ITEHDMI() active port --> HDMI PORT 0\r\n"));
	}
	else
	{
		IT6602_CEC_PRINT(("IT6602_CECPowerOn By ITEHDMI() active port --> HDMI PORT 1\r\n"));
	}
