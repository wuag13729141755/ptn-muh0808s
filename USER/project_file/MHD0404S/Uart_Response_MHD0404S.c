...
void Uart4VarInit(void)
{
	...
	puartCommVar->pRecBuffer = uart4_rec_buffer;

    puartCommVar->SetBaudRate = uart4_set_baudrate;
    puartCommVar->SendBytes = uart4_send_bytes_A;
    puartCommVar->SendString = uart4_send_string_A;
#if (_ENABLE_USER_PRINTF_FUNCTION==_MACRO_ENABLE)
