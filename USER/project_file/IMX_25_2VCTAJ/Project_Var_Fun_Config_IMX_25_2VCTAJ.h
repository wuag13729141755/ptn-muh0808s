...
#define SaveSpecificVarInit				IMX_25_2VCTAJ_SpecificVarInit
#define EepSpecVarInvalid				IMX_25_2VCTAJ_SpecVarValidCheck
#define PrjStatePowerOnInit				IMX_25_2VCTAJ_PrjStatePowerOnInit
#if _ENABLE_NEW_USER_KEY_DEFINE_FUNCTION
#define mapp_NewKeyPadProcess           mapp_KeyFunctionProcess
#endif
#define StartupMessage 					mapp_IMX_25_2VCTAJStartupMessage
#define SaveSpecificVarDefault          IMX_25_2VCTAJ_SpecificVarDefault
...
INTERFACE void IMX_25_2VCTAJ_SpecificVarInit(void);
INTERFACE void IMX_25_2VCTAJ_SpecBasicVarDefault(void);
INTERFACE void IMX_25_2VCTAJ_SpecCustomEdidVarDefault(void);
INTERFACE bool IMX_25_2VCTAJ_SpecVarValidCheck(void);
// the status when power on device
INTERFACE void IMX_25_2VCTAJ_PrjStatePowerOnInit(void);
INTERFACE void IMX_25_2VCTAJ_LedWork_Loop(void);
INTERFACE void IMX_25_2VCTAJ_FuncWork_LoopRunning(void);
INTERFACE void SetUserData_SpecBasicVar(void);
INTERFACE void SetUserData_SpecCustomEdid(uint8_t u8CustomEdidIndex);
INTERFACE void mapp_IMX_25_2VCTAJStartupMessage(void);
