...
#define SaveSpecificVarInit				MUH0808SPro_SpecificVarInit
#define EepSpecVarInvalid				MUH0808SPro_SpecVarValidCheck
#define PrjStatePowerOnInit				MUH0808SPro_PrjStatePowerOnInit
#if _ENABLE_NEW_USER_KEY_DEFINE_FUNCTION
#define mapp_NewKeyPadProcess           mapp_KeyFunctionProcess
#endif
#define StartupMessage 					mapp_MUH0808SProStartupMessage
#define SaveSpecificVarDefault          MUH0808SPro_SpecificVarDefault
...
INTERFACE void MUH0808SPro_SpecificVarInit(void);
INTERFACE void MUH0808SPro_SpecBasicVarDefault(void);
INTERFACE void MUH0808SPro_SpecCustomEdidVarDefault(void);
INTERFACE bool MUH0808SPro_SpecVarValidCheck(void);
// the status when power on device
INTERFACE void MUH0808SPro_PrjStatePowerOnInit(void);
INTERFACE void MUH0808SPro_LedWork_Loop(void);
INTERFACE void MUH0808SPro_FuncWork_LoopRunning(void);
INTERFACE void SetUserData_SpecBasicVar(void);
INTERFACE void SetUserData_SpecCustomEdid(uint8_t u8CustomEdidIndex);
INTERFACE void mapp_MUH0808SProStartupMessage(void);
INTERFACE void app_MUH0808SProSetSplicerPixelDisplay(u8 u8Dev,u8 u8Tx,u16 u16X,u16 u16Y,u16 u16Width,u16 u16Height);
INTERFACE void app_MUH0808SProSetSplicerDisplay(u8 u8Dev,u8 u8Tx,u8 u8H,u8 u8W,u8 u8Index);
INTERFACE void app_MUH0808SProPictureAdjust(u8 u8Dev,u8 u8Tx,u8 u8Value,u8 u8Mode);
INTERFACE void app_MUH0808SProSetSplicerBorder(u8 u8Tx,u8 u8H,u8 u8W,u8 u8Index,u16 u16BorderWidth,u16 u16BorderHeight);
INTERFACE void app_MUH0808SProSwitchSourceFreeze(u8 u8Dev,u8 u8TxPath,bool bEnFreeze);
INTERFACE void app_MUH0808SProSourceSwitch(u8 u8Out,u8 u8In);
INTERFACE void app_MUH0808SProSceneSave(u8 u8SceneID);
INTERFACE void app_MUH0808SProSceneCall(u8 u8SceneID);
INTERFACE void app_MUH0808SProScenePollingFunction(void);
