...
#define SaveSpecificVarInit				MUH0808S_SpecificVarInit
#define EepSpecVarInvalid				MUH0808S_SpecVarValidCheck
#define PrjStatePowerOnInit				MUH0808S_PrjStatePowerOnInit
#if _ENABLE_NEW_USER_KEY_DEFINE_FUNCTION
#define mapp_NewKeyPadProcess           mapp_KeyFunctionProcess
#endif
#define StartupMessage 					mapp_MUH0808SStartupMessage
#define SaveSpecificVarDefault          MUH0808S_SpecificVarDefault
...
typedef __packed struct _stScenePollingVar_t_
{
	...
	uint8_t         u8PollingListSave[32];//wu:记录场景号在列表哪个位置
...
//    uint16_t        u16BorderSizeH[Def_outport_num];
    ...
    uint8_t         u8SplitterMode[2];
    uint8_t         u8SplitterWinSrc[2][4];
...
INTERFACE void MUH0808S_SpecificVarInit(void);
INTERFACE void MUH0808S_SpecBasicVarDefault(void);
INTERFACE void MUH0808S_SpecCustomEdidVarDefault(void);
INTERFACE bool MUH0808S_SpecVarValidCheck(void);
// the status when power on device
INTERFACE void MUH0808S_PrjStatePowerOnInit(void);
INTERFACE void MUH0808S_LedWork_Loop(void);
INTERFACE void MUH0808S_FuncWork_LoopRunning(void);
INTERFACE void SetUserData_SpecBasicVar(void);
INTERFACE void SetUserData_SpecCustomEdid(uint8_t u8CustomEdidIndex);
INTERFACE void mapp_MUH0808SStartupMessage(void);
INTERFACE void app_MUH0808SSetSplicerPixelDisplay(u8 u8dev,u8 u8Tx,u16 u16X,u16 u16Y,u16 u16Width,u16 u16Height);
INTERFACE void app_MUH0808SSetSplicerDisplay(u8 u8dev,u8 u8Tx,u8 u8H,u8 u8W,u8 u8Index,u8 u8x,u8 u8y);
INTERFACE void app_MUH0808SPictureAdjust(u8 u8dev,u8 u8Tx,u8 u8Value,u8 u8Mode);
INTERFACE void app_MUH0808SSetSplicerBorder(u8 u8Tx,u8 u8H,u8 u8W,u8 u8Index,u16 u16BorderWidth,u16 u16BorderHeight);
INTERFACE void app_MUH0808SSwitchSourceFreeze(u8 u8dev,u8 u8TxPath,bool bEnFreeze);
INTERFACE void app_MUH0808SSourceSwitch(u8 u8Out,u8 u8In);
INTERFACE void app_MUH0808SSceneSave(u8 u8SceneID);
INTERFACE void app_MUH0808SSceneCall(u8 u8SceneID);
INTERFACE void app_MUH0808SScenePollingFunction(void);
