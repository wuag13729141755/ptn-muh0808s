...
const stUartCmdList2 cmd_list[]=
{
    ...
    { Flag_HeadMatch|Flag_UserValueLength|Flag_ShowHelpCommand,     // flag
        ...
        6,                      // valuelen
        1,                      // cmdoffset
        eFunc_SetOSDStringEnable,  // eCmdFun
        " ",         // feedbackstring
        },
    { Flag_HeadMatch|Flag_ShowHelpCommand,     // flag
        "(get,osd.en,",     //ucmd
        ...
        3,                      // valuelen
        1,                      // cmdoffset
        eFunc_GetOSDStringEnable,  // eCmdFun
        " ",         // feedbackstring
        },
    { Flag_HeadMatch|Flag_UserValueLength|Flag_ShowHelpCommand,     // flag
        "(set,osd.color,",     //ucmd
        ...
        6,                      // valuelen
        1,                      // cmdoffset
        eFunc_SetOSDStringColor,  // eCmdFun
        " ",         // feedbackstring
        },
    { Flag_HeadMatch|Flag_ShowHelpCommand,     // flag
        "(get,osd.color,",     //ucmd
        ...
        3,                      // valuelen
        1,                      // cmdoffset
        eFunc_GetOSDStringColor,  // eCmdFun
        " ",         // feedbackstring
        },
    { Flag_HeadMatch|Flag_UserValueLength|Flag_ShowHelpCommand,     // flag
        "(set,osd.pos,",     //ucmd
        ...
        6,                      // valuelen
        1,                      // cmdoffset
        eFunc_SetOSDStringPosition,  // eCmdFun
        " ",         // feedbackstring
        },
    { Flag_HeadMatch|Flag_ShowHelpCommand,     // flag
        "(get,osd.pos,",     //ucmd
        ...
        3,                      // valuelen
        1,                      // cmdoffset
        eFunc_GetOSDStringPosition,  // eCmdFun
        " ",         // feedbackstring
        },
    { Flag_HeadMatch|Flag_UserValueLength|Flag_ShowHelpCommand,     // flag
        "(set,osd,",     //ucmd
    ...
    { Flag_HeadMatch|Flag_UserValueLength|Flag_ShowHelpCommand,     // flag
        "(set,splitupdate,",     //ucmd
        17,                     // cmdlen
        7,                      // valuelen
        1,                      // cmdoffset
        eFunc_SetSplitUpdate,  // eCmdFun
        " ",         // feedbackstring
        },
    { Flag_HeadMatch|Flag_UserValueLength|Flag_ShowHelpCommand,     // flag
        "(set,splitavsw,",     //ucmd
        ...
        10,                      // valuelen
        1,                      // cmdoffset
        eFunc_SetSplitAVSwitch,  // eCmdFun
        " ",         // feedbackstring
        },
    { Flag_HeadMatch|Flag_UserValueLength|Flag_ShowHelpCommand,     // flag
        "(get,splitavsw,",     //ucmd
        ...
        5,                      // valuelen
        1,                      // cmdoffset
        eFunc_GetSplitAVSwitch,  // eCmdFun
        " ",         // feedbackstring
        },
