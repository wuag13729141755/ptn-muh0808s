...
typedef enum _emKeyValueType
{
    ...
    emKeyvalueDisplayOn     = BIT1,
    emKeyvalueDisplayOff    = BIT2,
    //emKeyvalueVolumeMute    = BIT3,
    //emKeyvalueVolumeDec     = BIT4,
    //emKeyvalueVolumeInc     = BIT5,
    emKeyvalueEDID0         = 0x00,
    emKeyvalueEDID1         = 0x01,
    emKeyvalueEDID2         = 0x02,
    emKeyvalueEDID3         = 0x03,
    emKeyvalueEDID4         = 0x04,
    emKeyvalueEDID5         = 0x05,
    emKeyvalueEDID6         = 0x06,
    emKeyvalueEDID7         = 0x07,
    emKeyvalueEDID8         = 0x08,
    emKeyvalueEDID9         = 0x09,
    emKeyvalueEDID10        = 0x0A,
    emKeyvalueEDID11        = 0x0B,
    emKeyvalueEDID12        = 0x0C,
    emKeyvalueEDID13        = 0x0D,
    emKeyvalueEDID14        = 0x0E,
    emKeyvalueEDID15        = 0x0F,
}emKeyValueType;
