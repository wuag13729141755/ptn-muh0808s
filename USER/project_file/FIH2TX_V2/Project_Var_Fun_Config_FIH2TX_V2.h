...
#define SaveSpecificVarInit				F1H2TX_V2_SpecificVarInit
#define EepSpecVarInvalid				F1H2TX_V2_SpecVarValidCheck
#define PrjStatePowerOnInit				F1H2TX_V2_PrjStatePowerOnInit
#if _ENABLE_NEW_USER_KEY_DEFINE_FUNCTION
#define mapp_NewKeyPadProcess           mapp_KeyFunctionProcess
#endif
#define StartupMessage 					mapp_F1H2TX_V2StartupMessage
#define SaveSpecificVarDefault          F1H2TX_V2_SpecificVarDefault
...
INTERFACE void F1H2TX_V2_SpecificVarInit(void);
INTERFACE void F1H2TX_V2_SpecBasicVarDefault(void);
INTERFACE void F1H2TX_V2_SpecCustomEdidVarDefault(void);
INTERFACE bool F1H2TX_V2_SpecVarValidCheck(void);
// the status when power on device
INTERFACE void F1H2TX_V2_PrjStatePowerOnInit(void);
INTERFACE void F1H2TX_V2_LedWork_Loop(void);
INTERFACE void F1H2TX_V2_FuncWork_LoopRunning(void);
INTERFACE void SetUserData_SpecBasicVar(void);
INTERFACE void SetUserData_SpecCustomEdid(uint8_t u8CustomEdidIndex);
INTERFACE void mapp_F1H2TX_V2StartupMessage(void);
INTERFACE void mapp_F1H2TX_V2_SetPort(u8 u8Port);
