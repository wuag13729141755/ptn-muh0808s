...
#define SaveSpecificVarInit				MUH1616S_OUTPUT_SpecificVarInit
#define EepSpecVarInvalid				MUH1616S_OUTPUT_SpecVarValidCheck
#define PrjStatePowerOnInit				MUH1616S_OUTPUT_PrjStatePowerOnInit
#if _ENABLE_NEW_USER_KEY_DEFINE_FUNCTION
#define mapp_NewKeyPadProcess           mapp_KeyFunctionProcess
#endif
#define StartupMessage 					mapp_MUH1616S_OUTPUTStartupMessage
#define SaveSpecificVarDefault          MUH1616S_OUTPUT_SpecificVarDefault
...
typedef enum _emUserTimerType_t_
{
    ...
    emUserTimer_SwitchFreezeRecoveryDelayTime,
...
//    uint8_t         u8UartMode;
    uint8_t         u8ExternalAudioMute[Def_outport_num];
...
INTERFACE void MUH1616S_OUTPUT_SpecificVarInit(void);
INTERFACE void MUH1616S_OUTPUT_SpecBasicVarDefault(void);
INTERFACE void MUH1616S_OUTPUT_SpecCustomEdidVarDefault(void);
INTERFACE bool MUH1616S_OUTPUT_SpecVarValidCheck(void);
// the status when power on device
INTERFACE void MUH1616S_OUTPUT_PrjStatePowerOnInit(void);
INTERFACE void MUH1616S_OUTPUT_LedWork_Loop(void);
INTERFACE void MUH1616S_OUTPUT_FuncWork_LoopRunning(void);
INTERFACE void SetUserData_SpecBasicVar(void);
INTERFACE void SetUserData_SpecCustomEdid(uint8_t u8CustomEdidIndex);
INTERFACE void mapp_MUH1616S_OUTPUTStartupMessage(void);
INTERFACE void app_MUH1616S_OUTPUTSetSplicerPixelDisplay(u8 u8Dev,u8 u8Tx,u16 u16X,u16 u16Y,u16 u16Width,u16 u16Height);
INTERFACE void app_MUH1616S_OUTPUTSetSplicerDisplay(u8 u8Dev,u8 u8Tx,u8 u8H,u8 u8W,u8 u8Index);
INTERFACE void app_MUH1616S_OUTPUTPictureAdjust(u8 u8Dev,u8 u8Tx,u8 u8Value,u8 u8Mode);
INTERFACE void app_MUH1616S_OUTPUTSetSplicerBorder(u8 u8Tx,u8 u8H,u8 u8W,u8 u8Index,u16 u16BorderWidth,u16 u16BorderHeight);
INTERFACE void app_MUH1616S_OUTPUTSwitchSourceFreeze(u8 u8Mode,u16 u16FreezeSta);
INTERFACE void app_MUH1616S_OUTPUTSourceSwitch(u8 u8Out,u8 u8In);
INTERFACE void mapp_MUH1616S_OutputSendCmdToInout(u8 u8cmd,u8 *pu8Data, u16 u16Len);
